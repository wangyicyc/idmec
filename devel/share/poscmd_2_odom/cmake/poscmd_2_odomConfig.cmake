...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/cyc/MDEC/src/uav_simulator/fake_drone)
  set(poscmd_2_odom_DEVEL_PREFIX /home/cyc/MDEC/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/cyc/MDEC/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyc/MDEC/src/uav_simulator/fake_drone/${idir}'.  ${_report}")
    endif()
