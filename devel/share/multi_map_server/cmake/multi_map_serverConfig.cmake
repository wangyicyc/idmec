...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/cyc/MDEC/src/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/cyc/MDEC/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/cyc/MDEC/install)
...
if(NOT "/home/cyc/MDEC/devel/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/cyc/MDEC/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyc/MDEC/src/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
