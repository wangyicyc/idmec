import sys 
sys.path.append('..')
from ergodic_planning.fourier_utils import BasisFunc, get_phik, get_ck, get_ck_avg, get_ck_sum  # 获取Fourier基函数和系数
from ergodic_planning.ergodic_metric import ErgodicMetric # 计算遍历度指标
from ergodic_planning.metric_utils import pair_connection_doubleInt as func_connection_value
