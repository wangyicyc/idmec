...
# ==============================
file_path = '../datas/config/experiment2.yaml'
...
# 要绘制的方法
methods = ['Baseline4', 'Baseline5', 'Baseline6','iDMED']
colors = {
    'Baseline1': "#D400FF",
    'Baseline2': "#7A3CDD",
    'Baseline3': "#349CF7",
...
for map_id in map_ids:
    ...
    save_path = f'experiment2_map{map_id}.png'
...
if global_box_data:
    ...
    plt.xticks(ha='right')
    plt.tight_layout()
    plt.savefig('experiment2_box.png', dpi=300, bbox_inches='tight')
    plt.close()
    print("✅ 全局箱线图已保存至: experiment2_box.png")
