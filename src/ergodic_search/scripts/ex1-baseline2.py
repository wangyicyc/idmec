...
decay_type = 'nodecay'
init_dual = True
save_path = '../figures/ex1-baseline2.png'
map_merge_cnt = 0
...
# 注意：调用该函数时，需要确保每个 map_id 下的不同 baseline 是依次添加的
...
save_ergodic_metrics_to_yaml(global_metric, "baseline2", map_id=args.map_id)
